...
class gotenna_pro_tx_usrp(gr.top_block):
    ...
    def __init__(self, baud_rate=9600, callsign='VE3IRR', counter_num=0, device_addr='', frequency=450000000, message='Hello world!', message_type='BROADCAST', publickey_data='base64key', recipient_gid=1234567891, sender_gid=1234567890):
...
def argument_parser():
    ...
    parser.add_argument(
        "--device-addr", dest="device_addr", type=str, default='',
        help="Set UHD device address [default=%(default)r]")
    parser.add_argument(
